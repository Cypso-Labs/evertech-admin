  ...
  return (
    <div>
      <div className="mb-12 flex items-center text-[40px] font-medium text-[#475569] dark:text-white">
       ...
       <span className="text-[40px font-medium]">Edit Customer</span> <span className="ml-2"> #{formData.id || "0001"}</span>
      </div>
        ...
        <div>
          <div className="col-span-3 space-y-6">
            ...
            <input
              ...
              value={formData.date}
              onChange={handleInputChange}
              className="h-[36px] w-[520px] border border-gray-300 bg-[#E8E8E8] dark:border-slate-500 dark:bg-slate-600 rounded-md"
            />
          </div>
